...
<div class="right-panel">
  ...
  <a href="../index.php" style="display:inline-flex;align-items:center;gap:0.5rem;background:var(--red);color:#fff;padding:0.9rem 2.5rem;border-radius:50px;font-weight:700;text-decoration:none;box-shadow:0 6px 20px rgba(195,54,67,0.3);">Back to Home →</a>
    </div>
