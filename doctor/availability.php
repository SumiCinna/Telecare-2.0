...
$page_title       = 'Fees & Availability — TELE-CARE';
$page_title_short = 'Fees & Availability';
$active_nav       = 'availability';
require_once 'includes/header.php';
?>

<style>
  .sched-row{display:grid;grid-template-columns:1fr 1fr 1fr auto;gap:0.6rem;align-items:center;}
  ...
  .sched-remove{background:rgba(195,54,67,0.08);border:none;border-radius:8px;width:34px;height:34px;display:flex;align-items:center;justify-content:center;cursor:pointer;color:var(--red);transition:all .2s;flex-shrink:0;}
  .sched-remove:hover{background:rgba(195,54,67,0.18);}
  .btn-add-sched{display:inline-flex;align-items:center;gap:0.4rem;background:rgba(63,130,227,0.1);color:var(--blue);border:none;border-radius:50px;padding:0.45rem 1rem;font-size:0.8rem;font-weight:700;cursor:pointer;font-family:'DM Sans',sans-serif;transition:all .2s;}
  ...
  .sched-pagination button{background:rgba(36,68,65,.07);color:var(--green);border:none;border-radius:50px;padding:.4rem .9rem;font-size:.78rem;font-weight:700;cursor:pointer;font-family:'DM Sans',sans-serif;}
...
<div class="page">
  ...
  <div class="section-label">Fees &amp; Availability</div>
