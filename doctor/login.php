...
<head>
  ...
  <title>Doctor Login — TELE-CARE</title>
...
<div class="card">
  ...
  <div class="subtitle">Doctor Portal — Sign in to continue</div>
  ...
  <form method="POST">
    <div class="form-field">
      ...
      <input type="email" name="email" class="field-input" placeholder="doctor@email.com" required value="<?= htmlspecialchars($_POST['email'] ?? '') ?>"/>
    </div>
    <div class="form-field">
  ...
  <div style="display:flex;align-items:center;gap:0.75rem;margin:1.2rem 0">
    <div style="flex:1;height:1px;background:rgba(36,68,65,.1)"></div>
    <span style="font-size:.75rem;color:#9ab0ae;white-space:nowrap">or continue with</span>
    <div style="flex:1;height:1px;background:rgba(36,68,65,.1)"></div>
  </div>

  <!-- Google Login Button -->
  <a href="../auth/google-doctor-login.php" style="
