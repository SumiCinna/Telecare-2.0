...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; margin:0; padding:0; }
    body { font-family:'DM Sans',sans-serif; background:var(--bg); color:var(--green); min-height:100vh; padding-bottom:80px; }
    ...
    /* PAGE */
    .page { padding:1rem 1rem 1rem; max-width:600px; margin:0 auto; }
