...
<head>
  ...
  <title>Medtech Login — TELE-CARE</title>
...
<div class="card">
  ...
  <div class="subtitle">Medtech Portal — Sign in to continue</div>

  <div class="alert-error">Frontend preview mode: use any details to continue.</div>

  <form action="dashboard.php" method="GET">
    <div class="form-field">
      <label class="field-label">Email Address</label>
      <input type="email" name="email" class="field-input" placeholder="medtech@email.com" required/>
    </div>
    <div class="form-field">
  ...
  <div class="footer-link">
    Need help? <a href="mailto:support@telecare.local">Contact Support</a>
  </div>
</div>
</body>
</html>
