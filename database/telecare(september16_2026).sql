...
CREATE TABLE `doctor_ratings` (
  ...
  KEY `doctor_id` (`doctor_id`),
  CONSTRAINT `doctor_ratings_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`id`) ON DELETE CASCADE,
  CONSTRAINT `doctor_ratings_ibfk_2` FOREIGN KEY (`doctor_id`) REFERENCES `doctors` (`id`) ON DELETE CASCADE,
  CONSTRAINT `chk_doctor_rating_range` CHECK ((`rating` between 1 and 5))
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `doctor_ratings` VALUES (1,1,4,5,'Very professional','2026-09-11 07:28:30','2026-09-11 07:28:30');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_doctor_ratings_after_insert` AFTER INSERT ON `doctor_ratings` FOR EACH ROW BEGIN
  UPDATE `doctors` d
  SET d.rating = (SELECT ROUND(AVG(r.rating), 1) FROM `doctor_ratings` r WHERE r.doctor_id = NEW.doctor_id),
      d.rating_count = (SELECT COUNT(*) FROM `doctor_ratings` r WHERE r.doctor_id = NEW.doctor_id)
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_doctor_ratings_after_update` AFTER UPDATE ON `doctor_ratings` FOR EACH ROW BEGIN
  UPDATE `doctors` d
  SET d.rating = (SELECT ROUND(AVG(r.rating), 1) FROM `doctor_ratings` r WHERE r.doctor_id = NEW.doctor_id),
      d.rating_count = (SELECT COUNT(*) FROM `doctor_ratings` r WHERE r.doctor_id = NEW.doctor_id)
  WHERE d.id = NEW.doctor_id;

  -- Rare edge case: doctor_id itself was changed on the row.
  IF OLD.doctor_id <> NEW.doctor_id THEN
    UPDATE `doctors` d
    SET d.rating = (SELECT COALESCE(ROUND(AVG(r.rating), 1), 0.0) FROM `doctor_ratings` r WHERE r.doctor_id = OLD.doctor_id),
        d.rating_count = (SELECT COUNT(*) FROM `doctor_ratings` r WHERE r.doctor_id = OLD.doctor_id)
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_doctor_ratings_after_delete` AFTER DELETE ON `doctor_ratings` FOR EACH ROW BEGIN
  UPDATE `doctors` d
  SET d.rating = (SELECT COALESCE(ROUND(AVG(r.rating), 1), 0.0) FROM `doctor_ratings` r WHERE r.doctor_id = OLD.doctor_id),
      d.rating_count = (SELECT COUNT(*) FROM `doctor_ratings` r WHERE r.doctor_id = OLD.doctor_id)
  WHERE d.id = OLD.doctor_id;
...
INSERT INTO `doctor_schedules` VALUES (136,5,'Monday','06:00:00','13:00:00'),(137,5,'Monday','15:00:00','19:00:00'),(138,5,'Friday','06:00:00','14:00:00'),(139,5,'Saturday','06:00:00','14:00:00'),(151,4,'Monday','09:00:00','17:00:00'),(152,4,'Tuesday','09:00:00','17:00:00'),(153,4,'Wednesday','09:00:00','17:00:00'),(154,4,'Thursday','09:00:00','17:00:00'),(155,4,'Friday','09:00:00','17:00:00'),(156,4,'Saturday','09:00:00','17:00:00'),(157,4,'Sunday','09:00:00','17:00:00');
...
INSERT INTO `doctors` VALUES (4,'EXAMPLE DOCTOR#1','General','General Medicine / General Practice','','EXCELLCARE MEDICAL SYSTEM INC.','almondtofu25@gmail.com','$2y$10$KFzfCMLW/6YVdUWjiYG8b.g0yyUP6ZAW24jy1H7DrbopyR.btv15a','09999999999','uploads/profiles/doc_69b50c372d091.jfif','General doctor at EXCELLCARE MEDICAL SYSTEM INC.',500.00,'Filipino',5.0,1,'senior','active',1,'','',NULL,NULL,1,1,'2026-03-14 00:39:41',1,NULL,'2026-03-21 07:46:05',1,'2026-03-14 06:46:05','2026-09-11 07:28:30'),(5,'Ian Matthew Payawal','General','Cardiology','Cardiology','TELE-CARE STAFF','dizoah3@gmail.com','$2y$10$/WhcdL6CDFFo7M2w0ynJ4eq0kPxJ.Wnn/Nn4VhHl7.6evTz5DykqW','09999999992','uploads/profiles/doc_69bd4ead3abc2.png','Cardiology subspecialty',750.00,'English, Filipino',0.0,0,'junior','active',1,'','','uploads/docs/doc_5_69d7b40d58257.exe',NULL,1,0,'2026-04-09 08:13:33',1,NULL,'2026-03-22 11:33:12',1,'2026-03-15 10:33:12','2026-08-21 13:57:01'),(6,'EXAMPLE DOCTOR#2','General','Cardiology','','','xdreiaawe@gmail.com','$2y$10$0uhxv9h108ktfIiuuNvE9.IfYwnWXZNm958koGuybGGE.Mp1Kug36','',NULL,NULL,0.00,'',0.0,0,'junior','active',1,NULL,NULL,NULL,NULL,0,0,NULL,NULL,NULL,NULL,1,'2026-08-20 06:20:01','2026-09-04 14:27:24');
...
-- Dump completed on 2026-09-16 15:10:45
