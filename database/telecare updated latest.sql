...
INSERT INTO `appointments` VALUES (1,1,4,'2026-03-18','15:00:00','Teleconsult','Completed','Fever','Unpaid','2026-03-18 06:25:51');
...
INSERT INTO `doctor_schedules` VALUES (1,4,'Monday','14:30:00','19:45:00'),(2,4,'Tuesday','14:30:00','19:30:00'),(3,4,'Wednesday','14:30:00','19:30:00'),(4,5,'Monday','06:00:00','13:00:00'),(5,5,'Monday','15:00:00','19:00:00'),(6,5,'Friday','06:00:00','14:00:00'),(7,5,'Saturday','06:00:00','14:00:00');
...
CREATE TABLE `lab_requests` (
  ...
  `status` enum('Pending','Sent to MedTech','Processing','Results Ready','Completed','Cancelled') DEFAULT 'Pending',
  `staff_notes` text,
  `updated_by_staff_id` int unsigned DEFAULT NULL,
...
CREATE TABLE `patient_records` (
  ...
  `encoded_by_staff_id` int unsigned DEFAULT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `staff` (
  ...
  `role` enum('staff','senior_staff') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'staff',
...
INSERT INTO `staff` VALUES (4,'Sample Staff','staff@telecare.com','$2y$12$E4ItwcpdhXTwTG8LMlRqjuCeuJ82ejBgOA1xX8pD.iNgiyl0PYD3m','09000000000','staff',NULL,1,'2026-03-21 00:30:20','2026-03-21 00:20:24','2026-03-21 00:30:20');
...
CREATE TABLE `staff_notifications` (
  ...
  `type` enum('appointment','patient','lab','inventory','system') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'system',
...
-- Dump completed on 2026-03-21  1:50:55
