...
$receipt_no    = $appt['receipt_number'] ?? ('TC-' . strtoupper(substr(md5($appt_id), 0, 8)));
...
<style>
  ...
  @media print{.no-print{display:none!important;}.receipt-wrap{padding:0;}.receipt-card{box-shadow:none;border:none;}}
</style>
